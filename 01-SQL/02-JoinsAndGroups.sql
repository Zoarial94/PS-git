...
SELECT p.productName as "Product Name", SUM(o.quantityOrdered) as "Total # Ordered", p.MSRP * SUM(o.quantityOrdered) as "Total Sale" FROM products p JOIN orderdetails o ON p.productCode = o.productCode GROUP BY p.productCode ORDER BY 3 DESC; 
